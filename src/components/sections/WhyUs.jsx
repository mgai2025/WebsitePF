const pillars = [
    {
        ...
        headline: 'Vertical Integration & Intelligence',
        description: 'We eliminate the opacity of traditional trade through full-stack vertical integration. From cultivation to delivery, our platform provides intelligence and transparency across every segment.',
    },
    {
        icon: (
            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        headline: 'Systemic Reliability & Execution',
        description: '200+ annual shipments with a zero-incident track record. Our systems are engineered for the UK and European markets, ensuring seamless cross-border execution where others see obstacles.',
    },
    {
        icon: (
            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        ...
        headline: 'Institutional DNA',
        description: 'Led by IIT & IIM alumni with 50+ years of collective experience at Microsoft, Deloitte, JP Morgan, and Citi. We bring the operational rigor of a global MNC to the future of trade.',
    },
]
