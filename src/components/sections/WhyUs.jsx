const pillars = [
    ...
    },
    {
        ...
        headline: 'Decades of Executive Expertise',
        description: (
            <ul className="text-left space-y-2 mt-2">
                <li>• <strong>50+ years</strong> combined expertise across agriculture & global trade.</li>
                <li>• <strong>IIT & IIM alumni</strong> leadership.</li>
                <li>• Experience from <strong>Microsoft, Deloitte, Paytm, Apollo, JP Morgan, & Citi</strong>.</li>
                <li>• Global footprint: India, Africa, USA, Singapore, & Europe.</li>
            </ul>
        ),
    },
]
